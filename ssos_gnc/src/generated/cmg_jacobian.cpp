...
#else
  #define CASADI_PREFIX(ID) cmg_jacobian_ ## ID
#endif
...
static const casadi_int casadi_s7[3] = {3, 4, 1};
...
/* jacobFunc:(i0,i1,i2,i3)->(o0[3x4]) */
static int casadi_f2(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_int i, j;
  casadi_real *rr, *w0=w+0, w1, w2, w3, w4, w5, w6, *w7=w+18, *w8=w+21;
  const casadi_real *cs;
  /* #0: @0 = zeros(4x3) */
  casadi_clear(w0, 12);
  /* #1: @1 = 1000 */
  ...
  /* #5: @5 = ones(1x4,1nz) */
  w5 = 1.;
  /* #6: {@6, NULL, NULL, NULL} = horzsplit(@5) */
  w6 = w5;
  /* #7: @4 = (@4*@6) */
  w4 *= w6;
  /* #8: @2 = (@2*@4) */
  ...
  *rr++ = w5;
  ...
  /* #18: (@0[:12:4] = @7) */
  for (rr=w0+0, cs=w7; rr!=w0+12; rr+=4) *rr = *cs++;
  /* #19: @2 = input[1][0] */
  w2 = arg[1] ? arg[1][0] : 0;
  /* #20: @4 = sin(@2) */
  w4 = sin( w2 );
  /* #21: @5 = ones(1x4,1nz) */
  w5 = 1.;
  /* #22: {NULL, @3, NULL, NULL} = horzsplit(@5) */
  w3 = w5;
  /* #23: @4 = (@4*@3) */
  w4 *= w3;
  /* #24: @5 = -0.57743 */
  w5 = -5.7743021654867288e-01;
  /* #25: @6 = cos(@2) */
  w6 = cos( w2 );
  /* #26: @6 = (@6*@3) */
  w6 *= w3;
  ...
  *rr++ = w6;
  ...
  for (i=0, rr=w7, cs=w7; i<3; ++i) (*rr++)  = (w1*(*cs++));
  /* #34: (@0[1:13:4] = @7) */
  for (rr=w0+1, cs=w7; rr!=w0+13; rr+=4) *rr = *cs++;
  /* #35: @4 = 0.57743 */
  w4 = 5.7743021654867288e-01;
  /* #36: @5 = input[2][0] */
  w5 = arg[2] ? arg[2][0] : 0;
  ...
  /* #38: @2 = ones(1x4,1nz) */
  w2 = 1.;
  /* #39: {NULL, NULL, @3, NULL} = horzsplit(@2) */
  w3 = w2;
  /* #40: @6 = (@6*@3) */
  w6 *= w3;
  /* #41: @4 = (@4*@6) */
  ...
  *rr++ = w2;
  ...
  for (i=0, rr=w7, cs=w7; i<3; ++i) (*rr++)  = (w1*(*cs++));
  /* #50: (@0[2:14:4] = @7) */
  for (rr=w0+2, cs=w7; rr!=w0+14; rr+=4) *rr = *cs++;
  /* #51: @4 = input[3][0] */
  w4 = arg[3] ? arg[3][0] : 0;
  /* #52: @6 = sin(@4) */
  w6 = sin( w4 );
  /* #53: @2 = ones(1x4,1nz) */
  w2 = 1.;
  /* #54: {NULL, NULL, NULL, @5} = horzsplit(@2) */
  w5 = w2;
  /* #55: @6 = (@6*@5) */
  w6 *= w5;
  /* #56: @6 = (-@6) */
  ...
  *rr++ = w3;
  ...
  for (i=0, rr=w7, cs=w7; i<3; ++i) (*rr++)  = (w1*(*cs++));
  /* #67: (@0[3:15:4] = @7) */
  for (rr=w0+3, cs=w7; rr!=w0+15; rr+=4) *rr = *cs++;
  /* #68: @8 = @0' */
  for (i=0, rr=w8, cs=w0; i<3; ++i) for (j=0; j<4; ++j) rr[i+j*3] = *cs++;
  /* #69: output[0][0] = @8 */
  casadi_copy(w8, 12, res[0]);
  return 0;
}

extern "C" CASADI_SYMBOL_EXPORT int jacobFunc(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f2(arg, res, iw, w, mem);
}

extern "C" CASADI_SYMBOL_EXPORT int jacobFunc_alloc_mem(void) {
  return 0;
}

extern "C" CASADI_SYMBOL_EXPORT int jacobFunc_init_mem(int mem) {
  return 0;
}

extern "C" CASADI_SYMBOL_EXPORT void jacobFunc_free_mem(int mem) {
}

extern "C" CASADI_SYMBOL_EXPORT int jacobFunc_checkout(void) {
  return 0;
}

extern "C" CASADI_SYMBOL_EXPORT void jacobFunc_release(int mem) {
}

extern "C" CASADI_SYMBOL_EXPORT void jacobFunc_incref(void) {
}

extern "C" CASADI_SYMBOL_EXPORT void jacobFunc_decref(void) {
}

extern "C" CASADI_SYMBOL_EXPORT casadi_int jacobFunc_n_in(void) { return 4;}

extern "C" CASADI_SYMBOL_EXPORT casadi_int jacobFunc_n_out(void) { return 1;}

extern "C" CASADI_SYMBOL_EXPORT casadi_real jacobFunc_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

extern "C" CASADI_SYMBOL_EXPORT const char* jacobFunc_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
extern "C" CASADI_SYMBOL_EXPORT const char* jacobFunc_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
extern "C" CASADI_SYMBOL_EXPORT const casadi_int* jacobFunc_sparsity_in(casadi_int i) {
  switch (i) {
    case 0: return casadi_s4;
    case 1: return casadi_s4;
    case 2: return casadi_s4;
...
extern "C" CASADI_SYMBOL_EXPORT const casadi_int* jacobFunc_sparsity_out(casadi_int i) {
  switch (i) {
...
extern "C" CASADI_SYMBOL_EXPORT int jacobFunc_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 7;
  if (sz_res) *sz_res = 5;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 33;
...
extern "C" CASADI_SYMBOL_EXPORT int jacobFunc_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 7*sizeof(const casadi_real*);
  if (sz_res) *sz_res = 5*sizeof(casadi_real*);
  if (sz_iw) *sz_iw = 0*sizeof(casadi_int);
