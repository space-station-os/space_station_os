  ...
  int mem)
{
  ...
  casadi_real * w0 = w + 4, * w1 = w + 16, w2, w3, w4, w5, w6, w7, * w8 = w + 34, * w9 = w + 37,
    * w10 = w + 46, * w11 = w + 55;
  /* #0: @0 = zeros(4x3) */
  casadi_clear(w0, 12);
  /* #1: @1 = zeros(4x3) */
  ...
  *rr++ = w6;
  /* #18: @8 = (@2*@8) */
  for (i = 0, rr = w8, cs = w8; i < 3; ++i) {
    (*rr++) = (w2 * (*cs++));
  }
  /* #19: (@1[:12:4] = @8) */
  for (rr = w1 + 0, ss = w8; rr != w1 + 12; rr += 4) {
    *rr = *ss++;
  }
  /* #20: @3 = input[1][0] */
  w3 = arg[1] ? arg[1][0] : 0;
  ...
  *rr++ = w7;
  ...
  /* #35: (@1[1:13:4] = @8) */
  for (rr = w1 + 1, ss = w8; rr != w1 + 13; rr += 4) {
    *rr = *ss++;
  }
  /* #36: @5 = 0.57743 */
  ...
  *rr++ = w3;
  ...
  /* #51: (@1[2:14:4] = @8) */
  for (rr = w1 + 2, ss = w8; rr != w1 + 14; rr += 4) {
    *rr = *ss++;
  }
  /* #52: @5 = input[3][0] */
  w5 = arg[3] ? arg[3][0] : 0;
  ...
  *rr++ = w4;
  ...
  /* #68: (@1[3:15:4] = @8) */
  for (rr = w1 + 3, ss = w8; rr != w1 + 15; rr += 4) {
    *rr = *ss++;
  }
  /* #69: @9 =
  [[1, 0, 0],
  ...
  for (i = 0, rr = w10; i < 3; ++i) {
    for (j = 0; j < 3; ++j, ++rr) {
      for (k = 0, ss = w11 + j, tt = w1 + i * 4; k < 4; ++k) {
        *rr += ss[k * 3] * *tt++;
      }
    }
  }
  ...
  for (i = 0, rr = w0; i < 3; ++i) {
    for (j = 0; j < 4; ++j, ++rr) {
      for (k = 0, ss = w1 + j, tt = w9 + i * 3; k < 3; ++k) {
        *rr += ss[k * 4] * *tt++;
      }
    }
  }
